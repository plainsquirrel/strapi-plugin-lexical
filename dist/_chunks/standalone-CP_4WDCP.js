...
var dr = (e, t) => () => (t || e((t = { exports: {} }).exports, t), t.exports), Bt = (e, t) => {
...
var Me = (e, t, r) => (r = e != null ? yu(Bu(e)) : {}, _u(vt(r, "default", { value: e, enumerable: true }), e));
...
var Wn = dr((nr) => {
  ...
  function _i(e, t, r = {}) {
    let u = Bi(), i = e.split(Hn), { start: o, end: s, markerLines: a } = wi(t, i, r), D = t.start && typeof t.start.column == "number", l = String(s).length, f = e.split(Hn, s).slice(o, s).map((d, c) => {
...
var U = "string", H = "array", V = "cursor", T = "indent", k = "align", L = "trim", B = "group", N = "fill", w = "if-break", P = "indent-if-break", I = "line-suffix", R = "line-suffix-boundary", A = "line", O = "label", _ = "break-parent", Ke = /* @__PURE__ */ new Set([V, T, k, L, B, N, w, P, I, R, A, O, _]);
function Lu(e) {
...
function Tt(e, t = {}) {
  return Je(t.expandedStates), { type: B, id: t.id, contents: e, break: !!t.shouldBreak, expandedStates: t.expandedStates };
}
function wr(e) {
...
var Tr = { type: R }, Fe = { type: _ }, kr = { type: L }, Oe = { type: A, hard: true }, kt = { type: A, hard: true, literal: true }, qe = { type: A }, Lr = { type: A, soft: true }, K = [Oe, Fe], Xe = [kt, Fe], Z = { type: V };
function Se(e, t) {
  let r = [];
...
var jt = Qu;
var tn = /* @__PURE__ */ new Set(["tokens", "comments", "parent", "enclosingNode", "precedingNode", "followingNode"]), Zu = (e) => Object.keys(e).filter((t) => !tn.has(t));
function ei(e) {
...
var Ut = Me(st()), mn = (e, t, { descriptor: r }) => {
...
async function He(e, t) {
  ({ ast: e } = await ur(e, t));
  let r = /* @__PURE__ */ new Map(), n = new Jr(e), i = /* @__PURE__ */ new Map();
  await Mn(n, s, t, He, i);
...
var Xn = /* @__PURE__ */ new Set(["JsonRoot", "ObjectExpression", "ArrayExpression", "StringLiteral", "NumericLiteral", "BooleanLiteral", "NullLiteral", "UnaryExpression", "TemplateLiteral"]), Yi = /* @__PURE__ */ new Set(["OperationDefinition", "FragmentDefinition", "VariableDefinition", "TypeExtensionDefinition", "ObjectTypeDefinition", "FieldDefinition", "DirectiveDefinition", "EnumTypeDefinition", "EnumValueDefinition", "InputValueDefinition", "InputObjectTypeDefinition", "SchemaDefinition", "OperationTypeDefinition", "InterfaceTypeDefinition", "UnionTypeDefinition", "ScalarTypeDefinition"]);
function qn(e, t, r) {
  if (!t) return false;
  switch (e.parser) {
    case "flow":
...
var ao = de(ot, 0), Do = { parse: de(iu), formatAST: de(ou), formatDoc: de(su), printToDoc: de(au), printDocToString: de(Du) };
exports.__debug = Do;
exports.check = so;
exports.doc = ar;
exports.format = gu;
exports.formatWithCursor = Cu;
exports.getSupportInfo = ao;
exports.util = lr;
exports.version = lu;
